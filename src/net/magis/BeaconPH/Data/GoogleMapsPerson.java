...
public class GoogleMapsPerson extends Person implements Parcelable
{
	...
	public GoogleMapsPerson(int id, String lastName, String givenName, String lastLoc, int status, double lat, double lon)
	{
		super(id, lastName, givenName, lastLoc, status, lat, lon);
	}
    ...
    private GoogleMapsPerson(Parcel in) {
    	super(in.readInt(), in.readString(), in.readString(), in.readString(), in.readInt(), in.readDouble(), in.readDouble());
    }
}
